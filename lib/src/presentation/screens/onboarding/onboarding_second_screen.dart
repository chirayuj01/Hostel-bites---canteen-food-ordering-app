...
import 'package:food_ninja/src/presentation/screens/onboarding/onboarding_login_screen.dart';
        ...
        child: Align(
          child: Column(
            children: [
              ...
              Text(
                "Hostel Bites is where your comfort \nFood Lives",
              ...
              PrimaryButton(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => OnboardingLoginScreen()));
                },
              ),
              const SizedBox(height: 60),
            ],
