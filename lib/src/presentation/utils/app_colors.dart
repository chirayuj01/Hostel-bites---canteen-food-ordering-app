...
class AppColors {
  // general colors
  static const Color primaryColor = Color(0xffcb202d);
  static const Color primaryDarkColor = Color(0xffcb202d);
  ...
  static List<Color> secondaryGradient = [
    primaryColor,
    const Color.fromARGB(255, 210, 95, 104),
  ];
  static const Color kMain = Color(0xffcb202d);
